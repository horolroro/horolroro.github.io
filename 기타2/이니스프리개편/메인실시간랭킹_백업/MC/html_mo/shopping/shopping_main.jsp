    ...
    <div id="container"> 
        ...
        <div class="mainPopup">
            <section class="popupWrap">
                <!-- 타이틀 이미지 텍스트 조합 -->
                <a href="#">
                    <h2 class="title">온라인 전용관 오픈</h2>
                    <div class="img"><img src="/resources/mobile2/images/temp/main_pop.jpg" alt=""></div>
                    <div class="txt">
                        <p>
                            제주 왕벚잎의 브라이트닝 효과로 맑고 화사하게 건조하고 칙칙한 피부에 풍부한 수분을 전달하여 촉촉하고 생기있는 피부로 가꿔주는 투명 젤리 크림과 건조함 없이 피부에 밀착되어 자연스럽게 민낯을 밝혀주는 수분 생기 톤업 크림 패키지! 자연 유래 베타인의 수분 케어로 건조함 없이 성분인내추럴 베타인이 피부 위 수분이 날아가지 않도록 잡아주어 건조함 없이 촉촉한 피부로 케어해줍니다.
                        </p>
                        <div class="btn"><span style="background: #136d59;">자세히보기</span></div>
                    </div>
                </a>
                <!-- 타이틀 텍스트 조합 -->
                <!-- <a href="#">
                    <h2 class="title">이달사 무화과에디션 따라잡기<br />메이크업!10월 이.달.사 무화과에디션</h2>
                    <div class="txt">
                        <p>
                            이니클래스는 이니스프리의 회원 서비스 입니다.<br />
                            클래스 신청은 시작 1주일 전 오픈 되어 가능합니다.<br />
                            <br />
                            클래스 신청 마감 후 당첨자가 홈페이지에 공지되며, 당첨자에겐 개별 연락 드립니다. <br />
                            <br />
                            - 일시 : 2019년 10월 02일 수요일<br />
                            - 강사 :그린어스 강하영교육매니저<br />
                            - 가격 :무료클래스<br />
                            <br />
                            이달의 사자- 무화과 에디션 따라잡기 메이크업! <br />
                            기본 메이크업에 무화과 에디션으로 포인트 주는 가을 메이크업 클래스입니다. :)<br />
                            <br />
                            새로 출시된 이달사 무화과 에디션 제품으로 같이 놀아요~!
                        </p>
                        <div class="btn"><span style="background: #136d59;">자세히보기</span></div>
                    </div>
                </a> -->
                ...
                <!-- <a href="#">
                    <div class="img">
                        <img src="/resources/mobile2/images/temp/main_pop1.jpg" alt="">
                        <div class="btn"><span style="background: #632f10;">자세히보기</span></div>
                    </div>
                </a>
                <a href="#">
                    <div class="img">
                        <img src="/resources/mobile2/images/temp/main_pop2.jpg" alt="">
                        <div class="btn"><span style="background: #0e4035;">자세히보기</span></div>
                    </div>
                </a> -->
                <!-- //이미지두장 -->

                <div class="btnWrap">
                    <button type="button" onclick="mainPopClose('hide');">오늘 하루 보지 않기</button>
                    <button type="button" onclick="mainPopClose();">닫기</button>
                </div>
            </section>
        </div>
        <!-- body -->
                            ...
                            <div class="rankingList">
								...
								<div class="swiper-container swiper2">
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											<ul class="rolling">
												<li><a href="#"><em class="num">6</em>제주 용암해수 크림 마스크</a></li>
												<li><a href="#"><em class="num">7</em>제주 용암해수 크림 마스크 트루케어 논나노 논코메도 무기자차 선</a></li>
												<li><a href="#"><em class="num">8</em>제주 용암해수 크림 마스크</a></li>
												<li><a href="#"><em class="num">9</em>제주 용암해수 크림 마스크</a></li>
												<li><a href="#"><em class="num">10</em>제주 용암해수 크림 마스크</a></li>
											</ul>
										</div>
									</div>
								</div>
									...
									<div class="swiper-wrapper">
										...
										<div class="swiper-slide">
											<ul class="rolling">
												...
												<li><a href="#"><em class="num">8</em><span class="purchase">8590<em>명</em></span>제주 용암해수 크림 마스크</a></li>
												<li><a href="#"><em class="num">9</em><span class="purchase">8590<em>명</em></span>제주 용암해수 크림 마스크</a></li>
												<li><a href="#"><em class="num">10</em><span class="purchase">8590<em>명</em></span>제주 용암해수 크림 마스크</a></li>
											</ul>
                                        </div>
									</div>
								</div>
                ...
                <div class="memberShip">
                    ...
                    <div class="memberGuide">
                        <ul>
                            ...
                            <li>
                                <div class="iconGuide"><img src="/resources/mobile2/images/common/icon_seed.png" alt="씨드 혜택"></div>
                            ...
                            <li>
                                <div class="iconGuide"><img src="/resources/mobile2/images/common/icon_prime.png" alt="프라임 바우처 발급"></div>
