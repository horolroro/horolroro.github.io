...
var VisualSlideDefault = function() {
	...
	var afterSlide = function(){
		var img_h = $('.mainVisualDefault .swiper-wrapper').find('img').height();
		var img_h2 = $('.mainVisualDefault .vertical_col').find('img').height();
		if($('.vertical_col').length){
			$('.mainVisualDefault .slideControl').css({'top':img_h2 - 50 + 'px'});
		}else{
			console.log(img_h2)
