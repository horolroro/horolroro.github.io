...
<title>이니스프리 | Natural benefits from Jeju, innisfree</title>
<meta charset="utf-8">
...
<link rel="stylesheet" href="/resources/web2/css/slick.css">
...
<script type="text/javascript" src="/resources/web2/js/slick.min.js"></script>
...
<body>
	...
	<div id="wrap">
		...
		<!-- 메인 팝업 -->
		<jsp:include page="popup_main.jsp" />
		<!-- //메인 팝업 -->
				...
				<div class="slide">
					...
					<ul class="swiper-wrapper">
						<li class="swiper-slide">
							<span class="box cloumn3"> <!-- 3단 형태 cloumn3 -->
								<a href="#" class="left" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#222;">노토산 이중 스판 메쉬로 2번 쪼갠 마이크로 입자의<br>포뮬러가 무게감 없이 붙어 커버!</span>
										<strong class="tit" style="color:#222;">노토산 없이<br>착 붙는 커버 쿠션</strong>
										<strong>--------------------------------------------------------------------------------------------------------------------</strong>
										<span class="txt" style="color:#222;font-family: 'nanum',sans-serif;">나눔체 이중 스판 메쉬로 2번 쪼갠 마이크로 입자의<br>포뮬러가 무게감 없이 붙어 커버!/////</span>
										<strong class="tit" style="color:#222;font-family: 'nanum',sans-serif;">집에서 즐기는 홈케어</strong>
										<strong class="tit" style="color:#2dc2b2;font-family: 'nanum',sans-serif;">마스크 5+5</strong>
									</span>
									<span class="imgWrap">
								...
								<a href="#" class="center onePrd" style="background:#eedbd3;"> <!-- 제품 하나 일 경우 onePrd 추가 -->
									<span class="inner"> <!-- inner -->
										...
										<span class="txtWrap"> 
											<span class="name" style="color:blue;">마이 컨실러 [스팟 커버] 5.5g</span>
											<span class="hash" style="color:red;">
												<span>#화산송이</span>
												<span>#피지케어</span>
												<span>#모공청소기</span>
											</span>
						...
						<li class="swiper-slide">
							<span class="box">
								<a href="#" class="left" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#482a60;">제주 용암해수 에센스 또는 크림 마스크를 구매하고<br> 행운의 주인공이 되어 보세요~! </span>
										<strong class="tit" style="color:#482a60;">우리 집에<br> 리얼 냉장고가?!</strong>
									</span>
									<span class="imgWrap">
										<img src="/resources/web2/images/main/@key_visual1.jpg" alt="">
									</span>
								</a>
							</span>
						</li>
						<li class="swiper-slide">
							<span class="box">
								<a href="#" class="right" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#341b3b;">놓치면 후회해! 온라인 전용 상품<br>온라인 전용관에 더 많은 상품이  기다리고 있어요</span>
										<strong class="tit" style="color:#341b3b;">4만원 이상 구매시<br>편의점 기프티콘 </strong>
									</span>
									<span class="imgWrap">
										<img src="/resources/web2/images/main/@key_visual2.jpg" alt="">
									</span>
								</a>
							</span>
						</li>
						<li class="swiper-slide">
							<span class="box">
								<a href="#" class="center" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#043c57;">온라인 전용관에 더 많은 상품이 기다리고 있어요</span>
										<strong class="tit" style="color:#043c57;">스킨케어 50%할인</strong>
									</span>
									<span class="imgWrap">
										<img src="/resources/web2/images/main/@key_visual3.jpg" alt="">
									</span>
								</a>
							</span>
						</li>
						<li class="swiper-slide">
							<span class="box cloumn2"> <!-- 2단 형태 cloumn2 -->
								<a href="#" class="center" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#222;">피부톤을 보정해 하루 종일 밝고 화사한 피부 표현</span>
										<strong class="tit" style="color:#222;">피지 흡착 팩트</strong>
									</span>
									<span class="imgWrap">
								...
								<a href="#" class="center" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#222;">촉촉하고 생기 있는 피부로 가꿔주는 투명 젤리크림</span>
										<strong class="tit" style="color:#222;">왕벚꽃 젤리 크림</strong>
									</span>
									<span class="imgWrap">
						...
						<li class="swiper-slide">
							<span class="box cloumn3"> <!-- 3단 형태 cloumn3 -->
								<a href="#" class="left" style="background:#fff;">
									<span class="txtWrap">
										<span class="txt" style="color:#222;">이중 스판 메쉬로 2번 쪼갠 마이크로 입자의<br>포뮬러가 무게감 없이 붙어 커버!</span>
										<strong class="tit" style="color:#222;">무게감 없이<br>착 붙는 커버 쿠션</strong>
									</span>
									<span class="imgWrap">
										<img src="/resources/web2/images/main/@key_visual5.jpg" alt="" class="img">
									</span>
			...
			<section class="mainMemberShipInfo">
				...
				<div class="contWrap">
					...
					<ul class="list">
						...
						<li>
							<a href="#">
								<span class="icon"><img src="/resources/web2/images/main/icon_mb2.png" alt="씨드"></span>
						...
						<li>
							<a href="#">
								<span class="icon"><img src="/resources/web2/images/main/icon_mb5.png" alt="프라임 바우처 발급"></span>
