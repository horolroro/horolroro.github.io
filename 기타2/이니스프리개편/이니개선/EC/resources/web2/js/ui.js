...
/* 특정제품구매팝업 */
var popBuy = function(e,pageType) {
	var popPar;
	switch (pageType){
		case 'view' :
			popPar = $(e).closest('.btnWrap');
			break;
		case 'list' :
			popPar = $('#wrap');
			break;
	...
	var popHtml = "";
		...
		popHtml += '<div class="btn_wrap"><button type="button" class="btnType3l">확인</button></div>';
		popHtml += '<a href="#none" class="btn_close">닫기</a>';
		popHtml += '</div></div>';
		popPar.append(popHtml);
}
