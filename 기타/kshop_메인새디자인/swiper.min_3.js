...
/* JavaScript content from js/ui/idangerous.swiper.js in folder common */
var Swiper = function(selector, params) {
    ...
    function initEvents() {
        ...
        function _loadImage(src,errorPass) {
            var image = new Image();
        ...
        if (params.updateOnImagesReady) {
            ...
            for (var i = 0; i < _this.imagesToLoad.length; i++) {
                _loadImage(_this.imagesToLoad[i].getAttribute('src'),_this.imagesToLoad[i].getAttribute('errorPass'));
            }
        }
    }
